...
import ru.gb.accu.DailyForecast;
import ru.gb.accu.Headline;
import ru.gb.accu.Weather;
...
@Epic(value = "Тестирование API https://mock.server/forecast/v1/daily/1day/{locationkey}")
...
public class GetWeatherOneDayTest extends AbstractTest{
    ...
    @Test
    @DisplayName("GetWeatherOneDayTest.StatusOK")
    @Description("GET 1 Day of Daily Forecasts")
    @Link("")
    ...
    @Test
    @DisplayName("GetWeatherOneDayTest.StatusInternalServerError")
    @Description("GET 2 Days of Daily Forecasts")
    @Link("")
    @Severity(SeverityLevel.NORMAL)
    @Story(value = "Тестирование метода Forecast")
